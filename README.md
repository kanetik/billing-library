...
class CheckoutActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // by purchaseToken in the Recovered branch — see the Purchase
        // recovery guide for the full pattern. Persist
        // `handledRecoveredTokens` if the dedupe needs to survive process death.
